...
exports.deleteUserByRollno = async (req, res) => {
  const { rollno } = req.params; // Get the roll number from URL parameters
  try {
    ...
    // If user is found and deleted, send a success response
